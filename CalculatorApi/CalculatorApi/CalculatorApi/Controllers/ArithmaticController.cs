...
{ 
    ...
    [HttpGet("Addition")]
    public IActionResult Add([FromQuery] double[] numbers)
    {
    ...
    [HttpGet("Subtraction")]
    public IActionResult Subtract([FromQuery] double[] numbers)
    {
    ...
    public IActionResult Multiply([FromQuery] double[] numbers)
    {
    ...
    [HttpGet("Division")]
    public IActionResult Division([FromQuery] double[] numbers)
    {
        try
        {
